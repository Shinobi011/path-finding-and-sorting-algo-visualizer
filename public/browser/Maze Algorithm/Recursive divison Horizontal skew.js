// this is the implementation of the recursive division algorithm for generating a maze on a grid. 
// this algorithm generates the grid horizontally
// This algorithm is used to create a maze by recursively splitting the grid into smaller sections and 
// adding walls with passages through them. The result is a maze with a clear path from the start to the end.
