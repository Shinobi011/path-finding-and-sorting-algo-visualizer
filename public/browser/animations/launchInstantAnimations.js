// The launchInstantAnimations function is designed to visualize the execution of a pathfinding algorithm on a grid-based board.
// It animates the search process and highlights the shortest path, providing instant feedback as the algorithm progresses.
